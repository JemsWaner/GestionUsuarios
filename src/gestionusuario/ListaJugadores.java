...
public class ListaJugadores extends javax.swing.JFrame {
     ...
     * @param listaJuga
     */
    public ListaJugadores(Main listaJuga) {
        this.principal=listaJuga;
        initComponents();
        
        tableModel = (DefaultTableModel) jTable1.getModel();
        
        for (Jugador juga : principal.jugadores) {
            Object[] rows = {juga.getNombre(),juga.getPosicion(), juga.getIdentificacion(), juga.getEdad() };
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Posicion", "Identificacion", "Edad"
            }
        ));
